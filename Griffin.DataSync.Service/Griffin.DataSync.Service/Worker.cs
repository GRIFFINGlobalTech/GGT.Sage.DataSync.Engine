...
public class Worker : BackgroundService
{
        ...
        CancellationToken stoppingToken)
    {
        _logger.LogInformation(
            "Griffin Data Sync Worker started.");
        ...
        {
            _logger.LogInformation(
                "Griffin Data Sync Worker cancellation requested.");
        }
        catch (Exception ex)
        {
            _logger.LogError(
                ex,
                "Unexpected error while running SyncScheduler.");
        }

        _logger.LogInformation(
            "Griffin Data Sync Worker stopped.");
    }
}